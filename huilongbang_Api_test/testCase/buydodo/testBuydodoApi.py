...
class Buydodo_Api_Test(unittest.TestCase):
    ...
    def test_a_loginMD5_success(self):
        ...
        ExcelUtils.api_write_data("test",1,5,str({"_response":re_json}))
    ...
    def test_c_getUserInf_success(self):
        ...
        configHttp.set_data({
             "apiToken":apiToken,"channelId":channelId,"uid":userId, "imgUid":"15269803060001","client": "iOS", "clientVersion": "1.2", "d_model": "iPhone", "osVersion": "11.0.3",
            "networkType": "wifi"})
        response = configHttp.post()
        result = response.content.decode("utf-8")
    ...
    def test_d_gethomepageCatagory_success(self):
        ...
        configHttp.set_params("apiToken="+apiToken +"&channelId="+channelId+"&client=iOS&clientVersion=1.2&d_model=iPhone&networkType=WiFi&osVersion=11.0.3&uid="+userId)
